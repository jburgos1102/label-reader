    ...
    for field in selected_fields:
        ...
        if not selected_value:
            ...
            if field == "recipient_name" and recipient_selection_reason:
                ...
                selected_reason = (
                    "ocr_tracking" if tracking_source == "ocr" else tracking_source
                )
                if selected_reason == "unknown":
                    selected_reason = "tracking_detection"
            else:
        ...
        field_metadata = {
            ...
            "llm_confidence": llm_confidence.get(field),
...
def extract_label_data(image_path):
    ...
    llm_confidence = score_llm_result(llm_result, text)
    ...
    label_data["selected_sources"] = selected_sources
    log.debug("selected_sources=%s", selected_sources)
